...
<a href="/cos/resources/annex-a.pdf" id="homehoverlink1" style="background-image:linear-gradient(#F4F0E5 48%, #4a96b0 50%);">(See Annex A)</a>
...
<a href="/cos/resources/annex-a.pdf" id="homehoverlink1" style="background-image:linear-gradient(#F4F0E5 48%, #4a96b0 50%);">(See Annex B)</a> (Note: Annexes pending latest versions)
