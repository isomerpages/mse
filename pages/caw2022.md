    ...
    <h4><strong><center>HIGHLIGHTS</center></strong></h4>
      ...
      <div class="overflow-container">        
        <div class="card-event">
          ...
          <div class="card-event-infos">
            <h2><a href="#" class="external-link" target="_blank">Grab - Launch of Eco-Friendly Rides</a></h2>
            <p>9 Sep</p>
          </div>
        </div>
        <div class="card-event">
  ...
  <div class="card-event">
       ...
       <div class="card-event">
        ...
        <div class="card-event">
          ...
          <div class="card-event-infos">
            <h2><a href="https://docs.google.com/forms/d/16NHfPrb6tmVO0xd4EN8aO88AhGMBzovkGxzNo3b03kU/edit" class="external-link" target="_blank">Carb0n.fi - PALO IT & Carb0n.fi Panel Discussion & Networking</a></h2>
              <p>22 Sep</p>
          </div>
        </div>
        <div class="card-event">
          <img src="https://eventnook.s3.amazonaws.com/u/63753/coverimage_1603284234074_tp_logo.png" alt="logo" />
          <div class="card-event-infos">
            <h2><a href="https://www.facebook.com/CourtRC/posts/2970727956549849" class="external-link" target="_blank">Temasek Poly Green Interest Student Group & Rivervale Court Residents’ Network - Workshop on upcycling</a></h2>
              <p>23 Sep</p>
          </div>
        </div>
        <div class="card-event">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfqtDeUffwZnGYUJOugwNOx44rnx6PoeAmKlg-6BJpXU1vYKmtO--XFywc6Nq6us1XV8Q&usqp=CAU" alt="logo" />
          <div class="card-event-infos">
            <h2><a href="https://www.facebook.com/CourtRC/posts/2970727956549849" class="external-link" target="_blank">Earth 300 - Earth 300 Initiative online conference</a></h2>
              <p>23 Sep</p>
          </div>
        </div>
        <div class="card-event">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBAP-XeAUJIxboNC6mq3s7974evWAhOILoVA&usqp=CAU" alt="logo" />
          <div class="card-event-infos">
            <h2><a href="https://www.facebook.com/sgyouthclimateaction/posts/4651483871531851" class="external-link" target="_blank">Singapore Youth for Climate Action - "A Voice for Mother Nature" online event</a></h2>
              <p>23 Sep</p>
          </div>
        </div>
   <div class="card-event">
          <!-- <img src="" alt="logo" /> -->
          <div class="card-event-infos">
            <h2><a href="https://www.eventbrite.sg/e/online-art-and-sharing-tree-of-life-tickets-161868155009" class="external-link" target="_blank">Now Here - Tree of Life: Open Discussion Simple Exercises on the Skills of Compassion for Self, Others and the Earth</a></h2>
              <p>23 Sep</p>
          </div>
        </div>
        <div class="card-event">
          <!-- <img src="" alt="logo" /> -->
          <div class="card-event-infos">
            <h2><a href="https://tinyurl.com/ClimateScienceWoodlandsYouth" class="external-link" target="_blank">ClimateScience SG - Biodiversity & Climate Change Workshop</a></h2>
              <p>23 Sep</p>
          </div>
        </div> 
         <div class="card-event">
