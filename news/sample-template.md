...
For indentation, add margin-left in ol style (see example below). Suggested margin-left is 40px for the first indentation, and 20px increment for subsequent.
